const styles = {
  ...
  price: "font-[500] text-[16px] text-[#d55b45] pl-3 line-through",
  shop_name: "text-[20px] px-2 p-[1.5] font-[700]",
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-orange-500",
  button:"px-4 bg-orange-500 h-[50px] my-3 text-[16px] flex items-center justify-center rounded-xl cursor-pointer transition duration-300 hover:bg-orange-600",
