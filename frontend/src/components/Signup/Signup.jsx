          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-2 flex items-center">
                ...
                <label
                  htmlFor="file-input"
                  className="ml-5 flex items-center justify-center px-4 py-2 border border-orange-500 rounded-md shadow-sm text-sm font-medium text-orange-500 bg-white hover:bg-orange-100"
                >
            ...
            <div className={`${styles.noramlFlex} w-full`}>
              ...
              <Link to="/login" className="text-orange-500 pl-2">
                Sign In
              </Link>
            </div>
          </form>
