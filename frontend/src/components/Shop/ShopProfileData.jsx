      ...
      <div className="border-b border-gray-200 bg-gray-50">
        <div className="flex items-center justify-between px-2 sm:px-4 lg:px-6">
          <nav className="flex -mb-px">
            <button
              onClick={() => setActive(1)}
              className={`flex items-center gap-1 sm:gap-2 py-3 sm:py-4 px-2 sm:px-4 lg:px-6 text-xs sm:text-sm font-semibold border-b-2 transition-colors ${
                active === 1
          ...
          {isOwner && (
            <Link to="/dashboard" className="hidden sm:block">
              <button className="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm transition-colors">
                Dashboard
              </button>
            </Link>
          )}
            ...
            {allReviews && allReviews.length > 0 ? (
              <div className="space-y-3 sm:space-y-4 max-h-[400px] sm:max-h-[600px] overflow-y-auto">
                {allReviews.map((item, index) => (
                  <div
                    key={index}
                    className="flex gap-2 sm:gap-3 p-3 sm:p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
                  >
                    <img
