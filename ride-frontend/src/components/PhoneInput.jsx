      ...
      <div className="flex gap-2">
        ...
        <div className="flex-shrink-0 w-20 sm:w-24">
          <input
            ...
            value={countryCode}
            disabled
            className="w-full bg-gray-100 rounded-lg px-2 sm:px-3 py-2 sm:py-3 border border-gray-300 text-center text-base sm:text-lg font-semibold text-gray-700 cursor-not-allowed"
        ...
        <div className="flex-1">
          <input
            ...
            disabled={disabled}
            required={required}
            className={`w-full bg-[#eeeeee] rounded-lg px-3 sm:px-4 py-2 sm:py-3 border text-base sm:text-lg placeholder:text-sm sm:placeholder:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 ${
